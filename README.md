...
## Contenu du dossier
- `rapport_projet_onsir.pdf` : rapport officiel du projet (version finale à la racine du dépôt).
   - `rapport-jour-4-onsir.md` : version de travail / brouillon du rapport (si présente).
...
2. Vérifier que les fichiers ONISR sont placés dans `data/datasets/onsir/` :
